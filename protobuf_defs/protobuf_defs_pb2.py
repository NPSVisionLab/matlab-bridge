...
_IMAGESUBSTRATE = _descriptor.Descriptor(
  name='ImageSubstrate',
...
_VIDEOSUBSTRATE = _descriptor.Descriptor(
  name='VideoSubstrate',
...
_FRAMEPATHPAIR = _descriptor.Descriptor(
  name='FramePathPair',
...
_PRECISELOCATION = _descriptor.Descriptor(
...
class PreciseLocation(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
