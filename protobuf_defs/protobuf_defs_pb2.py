...
_FRAMEPATHPAIR = descriptor.Descriptor(
  ...
  fields=[
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='path', full_name='FramePathPair.path', index=1,
      number=2, type=9, cpp_type=9, label=1,
