function [image_substrate] = pb_read_ImageSubstrate(buffer, buffer_start, buffer_end)
%pb_read_ImageSubstrate Reads the protobuf message ImageSubstrate.
%   function [image_substrate] = pb_read_ImageSubstrate(buffer, buffer_start, buffer_end)
%
%   INPUTS:
